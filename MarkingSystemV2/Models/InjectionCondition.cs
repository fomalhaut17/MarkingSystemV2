...
public sealed class InjectionCondition
{
    ...
    [JsonPropertyName("BC_ITEMCOD")]   public string? BcItemCode   { get; init; }
    [JsonPropertyName("BC_BNO")]       public string? BcBno        { get; init; }
    [JsonPropertyName("BC_PD_TYPE")]   public string? BcPdType     { get; init; }
    [JsonPropertyName("BC_MECHCOD")]   public string? BcMechCode   { get; init; }
    [JsonPropertyName("BC_PRODATE")]   public string? BcProDate    { get; init; }
    [JsonPropertyName("BC_PROTIME")]   public string? BcProTime    { get; init; }
    [JsonPropertyName("BC_WRKPART")]   public string? BcWrkPart    { get; init; }
    [JsonPropertyName("COMPANY_CD")]   public string? CompanyCd    { get; init; }
    [JsonPropertyName("CHKDOCNO")]     public string? ChkDocNo     { get; init; }
    [JsonPropertyName("WORK_DAY")]     public string? WorkDay      { get; init; }
    [JsonPropertyName("CHK_NO")]       public string? ChkNo        { get; init; }
    [JsonPropertyName("FME_CD")]       public string? FmeCd        { get; init; }
    [JsonPropertyName("WORK_PART")]    public string? WorkPart     { get; init; }
    [JsonPropertyName("CHECK_TIME")]   public string? CheckTime    { get; init; }
    [JsonPropertyName("MECHCOD")]      public string? MechCod      { get; init; }
    [JsonPropertyName("KUM_COD")]      public string? KumCod       { get; init; }
    [JsonPropertyName("GONG_CO")]      public string? GongCo       { get; init; }
    ...
    [JsonPropertyName("GAS_DELAY_1")] public string? GasDelay1 { get; init; }
    [JsonPropertyName("GAS_DELAY_2")] public string? GasDelay2 { get; init; }
    [JsonPropertyName("GAS_DELAY_3")] public string? GasDelay3 { get; init; }
    [JsonPropertyName("GAS_DELAY_4")] public string? GasDelay4 { get; init; }
    [JsonPropertyName("GAS_DELAY_5")] public string? GasDelay5 { get; init; }
    ...
    [JsonPropertyName("CRE_DATE")] public string? CreDate   { get; init; }
    [JsonPropertyName("UP_DATE")]  public string? UpDate    { get; init; }
}
